...
private: // helper functions
	...
	// resize, manage allocation/deallocation, but not construction/destruction
...
// we use a strictly increasing allocation size policy with array length doubling to ensure that the cost of
// copying array entries on a reallocation has constant amortized cost.  This is important when the vector is used to accumulate a list of values.
template<class T, uint LEN> inline
